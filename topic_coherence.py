"""
Module that contains the methods plot_coherent_score_distribution and plot_number_coherent_topics.
Coherence score measures the amount of intruding words (irrelevant) inside the list of top words
associated with a topic given a model. It is used to measure the topics generated by a topic.
Higher the score, Better the quality.
"""
...
def plot_coherence_scores_distribution(n_common_words, model_names, n_topics, corpus_names):
    # given a model, for each topic number, plot the coherence scores of all the topics.
    base_dir = os.getcwd()
...
def plot_number_coherent_topics(corpus_names, model_names, n_common_words):
    # given a model, for each topic number, plot the number of topics above a certain threshold.
    base_dir = os.getcwd()
    output_dir = 'coherence'
